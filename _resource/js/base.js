...
var app = new Vue({
  ...
  data: {
    ...
    recommends: [
      ...
      {id: 2, url: 'https://www.rakuten.ne.jp/gold/mb/mb/article/100/rk.html', image: 'assets/image/rcmd_02.jpg', text: '春の音が聞こえてくるレディース最旬春コーデ', target: true},
